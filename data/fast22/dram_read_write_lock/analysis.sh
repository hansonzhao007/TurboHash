...
echo "thread,turbo,turbo_lock" >> $outfile_load
echo "thread,turbo,turbo_lock" >> $outfile_read
echo "thread,turbo,turbo_lock" >> $outfile_readnon
...
echo "thread,turbo,turbo_lock" >> $outfile_load_io
echo "thread,turbo,turbo_lock" >> $outfile_load_io_r
echo "thread,turbo,turbo_lock" >> $outfile_load_io_w
echo "thread,turbo,turbo_lock" >> $outfile_read_io
echo "thread,turbo,turbo_lock" >> $outfile_read_io_r
echo "thread,turbo,turbo_lock" >> $outfile_read_io_w
echo "thread,turbo,turbo_lock" >> $outfile_readnon_io
echo "thread,turbo,turbo_lock" >> $outfile_readnon_io_r
echo "thread,turbo,turbo_lock" >> $outfile_readnon_io_w
...
echo "thread,turbo,turbo_lock" >> $outfile_load_bw
echo "thread,turbo,turbo_lock" >> $outfile_load_bw_r
echo "thread,turbo,turbo_lock" >> $outfile_load_bw_w
echo "thread,turbo,turbo_lock" >> $outfile_read_bw
echo "thread,turbo,turbo_lock" >> $outfile_read_bw_r
echo "thread,turbo,turbo_lock" >> $outfile_read_bw_w
echo "thread,turbo,turbo_lock" >> $outfile_readnon_bw
echo "thread,turbo,turbo_lock" >> $outfile_readnon_bw_r
echo "thread,turbo,turbo_lock" >> $outfile_readnon_bw_w
