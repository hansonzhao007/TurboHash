...
hashtables = ['turbo', 'turbo_lock']
legend_name = ('TURBO-LockFree', 'TURBO-ReadLock')
...
def PlotScalability():
    ...
    Plot("scalability_read_io_r.parse", "scalability_read_io_r.pdf", -4, "", "Pmem I/O (GB)", 1024.0)
    Plot("scalability_read_io_w.parse", "scalability_read_io_w.pdf", -4, "", "Pmem I/O (GB)", 1024.0)
    Plot("scalability_readnon_io_r.parse", "scalability_readnon_io_r.pdf", -4, "", "Pmem I/O (GB)", 1024.0)
    Plot("scalability_readnon_io_w.parse", "scalability_readnon_io_w.pdf", -4, "", "Pmem I/O (GB)", 1024.0)
