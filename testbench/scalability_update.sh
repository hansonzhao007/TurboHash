...
do
    numactl -N $SOCKET_NO sudo ../CCEH-PMDK/ycsb_bench --thread=$t --benchmarks=load,overwrite,readrandom --stats_interval=10000000 --read=10000000 --num=120000000 | tee thread.cceh_$t
