...
do
    ...
    numactl -N $SOCKET_NO sudo ../Clevel-Hashing/release/tests/ycsb_bench_cceh30 --thread=$t --benchmarks=load,overwrite,readrandom  --stats_interval=10000000 --read=10000000 --num=120000000 | tee thread_update.cceh30_$t

    # numactl -N $SOCKET_NO sudo ../Clevel-Hashing/release/tests/ycsb_bench_clevel30 --thread=$t --benchmarks=load,overwrite,readrandom  --stats_interval=10000000 --read=10000000 --num=120000000 | tee thread_update.clevel30_$t

    numactl -N $SOCKET_NO sudo ../Clevel-Hashing/release/tests/ycsb_bench_clht30 --thread=$t --benchmarks=load,overwrite,readrandom  --stats_interval=10000000 --read=10000000 --num=120000000 | tee thread_update.clht30_$t
