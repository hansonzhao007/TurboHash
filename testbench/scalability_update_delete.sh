...
do
    numactl -N $SOCKET_NO sudo ../Dash/release/ycsb_bench  --thread=$t --benchmarks=load,overwrite,readrandom,delete,readrandom  --stats_interval=10000000 --read=10000000 --num=120000000 | tee thread_update_delete.dash_$t
