...
numactl -N $SOCKET_NO sudo ../Clevel-Hashing/release/tests/ycsb_bench --thread=$t --benchmarks=load,ycsbd,ycsba,ycsbb,ycsbc,ycsbf --stats_interval=10000000 --read=10000000 --num=120000000 | tee ycsb.clevel30
