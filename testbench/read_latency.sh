...
# numactl -N $SOCKET_NO sudo ../Clevel-Hashing/release/tests/ycsb_bench --thread=16 --benchmarks=load,readrandom,readlat,readnonlat --stats_interval=10000000 --read=10000000 --num=100000000 | tee read_latency.clht30
