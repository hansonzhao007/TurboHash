...
numactl -N 0 sudo ../release/hash_bench_30 --bucket_count=258 --cell_count=8192 --thread=8  --benchmarks=load,readrandom,rehashlat --stats_interval=100000000 --num=20000000 --no_rehash=true --read=0 --loadfactor=0.74 | tee  rehashlat2_8192

numactl -N 0 sudo ../release/hash_bench_30 --bucket_count=128 --cell_count=16384 --thread=8  --benchmarks=load,readrandom,rehashlat --stats_interval=100000000 --num=20000000 --no_rehash=true --read=0 --loadfactor=0.74 | tee  rehashlat2_16384